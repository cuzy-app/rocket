...
return array (
  ...
  'Go to {rocketUrl} -> "Custom Scripts". And in {buttonName} add (update {humhubUrl} const):' => 'עבור אל {rocketUrl} -> "סקריפטים מותאמים אישית". וב- {buttonName} הוסף (עדכון {humhubUrl} const):',
